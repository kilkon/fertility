...
ASSET_VERSION = "20260508-public-comments-readonly"
...
BOOK = [
    {
        ...
        "title": "왜 이 책을 썼는가",
        "file": "chapter-0.html",
        "thesis": "정책 진단이 추상적인 제안으로 끝나지 않으려면, 인구 변화를 데이터로 검산하고 정책의 실제 작동 조건을 차갑게 확인해야 한다.",
        "sections": [],
    },
    {
        "no": "1",
    ...
    {
        "no": "3",
        "title": "저출산 정책의 성과는 어떻게 검산해야 하는가",
        "file": "chapter-2.html",
...
CHAPTER_NARRATIVE = {
    "chapter-0.html": [
        ...
        "그래서 이 책은 정책 구호보다 검산을 앞세운다. 정부와 연구기관의 보고서를 존중하되, 그 결론을 그대로 반복하지 않는다. KOSIS, ECOS, e-나라지표, 열린재정, 저출산고령사회위원회 발간자료에서 데이터를 모아 같은 질문을 다시 던진다. 출산율이 아니라 출생아 수와 코호트 잔존을 보고, 전국 평균이 아니라 시군구 차이를 보고, 예산 총액이 아니라 사업 수와 세부사업의 방향을 본다.",
...
SECTION_DATA_EXPANSION = {
    ...
    "section-2-1-yeonggwang-cohort.html": [
        {
            ...
            "interpretation": "조출생률 상승이 지역 내 코호트 유지로 이어졌는지를 따로 검산해야 한다. 100% 초과는 코호트 유지가 아니라 전입을 포함한 순증으로 해석한다.",
        },
        {
    ...
    "section-4-2-men-care-parental-leave.html": [
        ...
        },
        {
            ...
            "interpretation": "남편의 돌보기 시간은 늘었지만 아내의 시간이 여전히 훨씬 길다. 제도 이용 확대가 일상적 돌봄 평등으로 이어지는지는 별도로 검산해야 한다.",
        },
        {
