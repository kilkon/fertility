    ...
    "section-2-3-family-conditions-dashboard.html": [
        {
            ...
            "files": [
                ...
                "data/derived/capital_youth_population_2025_summary.csv",
                "data/derived/capital_youth_population_2025_age.csv",
...
def build_derived_data() -> dict[str, list[dict[str, object]]]:
    ...
    for chart_id, filename in [
        ...
        ("capital_youth_population_share_2025", "capital_youth_population_2025_summary.csv"),
