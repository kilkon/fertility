...
따라서 적정인구 논의는 “한국 인구가 몇 명이어야 하는가”라는 기술적 문제로만 다루기 어렵다. 같은 인구 규모라도 수도권에 과도하게 몰려 있으면 주거비와 통근비가 커지고, 비수도권에서는 학교·의료·돌봄 서비스가 얇아질 수 있다. 같은 출생아 수라도 양육비와 교육비가 가족에게 집중되면 부모의 부담은 커지고, 사회가 돌봄과 교육을 함께 나누면 부담은 달라진다. 적정인구는 총량의 문제가 아니라 분포, 제도, 생산성, 환경, 권리가 결합된 문제다.
...
::: pause 적정인구를 하나의 숫자로 정하기 어려운 이유

| 쟁점 | 왜 어려운가 |
|---|---|
| 목표의 차이 | 전체 GDP를 극대화할 것인지, 1인당 후생을 높일 것인지, 환경 부담을 줄일 것인지에 따라 답이 달라진다. |
| 시간의 차이 | 지금의 노동력 부족을 완화하는 인구와 30년 뒤 재정·환경 부담을 줄이는 인구가 같지 않을 수 있다. |
| 분배의 차이 | 인구 증가의 이익은 기업·국가·지역에 돌아가고, 양육 비용은 특정 가구와 여성에게 집중될 수 있다. |
| 기술의 차이 | 자동화, 인공지능, 의료기술, 이민정책, 돌봄 기술이 인구 규모의 의미를 바꾼다. |
| 권리의 차이 | 출산은 국가 목표만으로 결정할 수 없는 개인의 삶과 몸, 가족 선택의 문제다. |
...
이 때문에 국가 개입의 정당성은 출산율 목표가 아니라 조건 개선에서 찾아야 한다. 국가는 누가 몇 명을 낳아야 하는지 정할 권한을 갖는 것이 아니라, 원하는 사람이 결혼·출산·양육을 선택할 때 부당한 손실을 겪지 않도록 제도를 고칠 책임을 갖는다. 이 차이는 작아 보이지만 결정적이다. 전자는 개인의 생애를 국가목표에 맞추려는 접근이고, 후자는 개인의 생애선택을 가능하게 하는 접근이다.
