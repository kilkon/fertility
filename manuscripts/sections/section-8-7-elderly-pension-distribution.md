...
전문가의 관점에서 보면 이 분포 변화에는 한국 노후소득 보장의 이중적 성격이 담겨 있다. 기초연금과 국민연금의 성숙은 낮은 수령액 구간을 줄이는 데 분명한 역할을 했다. 그러나 국민연금 가입 이력, 근로경력, 직역연금 여부, 사적연금 보유 여부가 서로 다르기 때문에 고령층 내부의 소득 격차는 쉽게 사라지지 않는다. 그래서 8.7절의 질문은 ‘평균이 올랐다’에서 멈추지 않고, ‘누가 여전히 낮은 구간에 남아 있는가’로 이어져야 한다.

이 질문은 정책 설계에도 중요하다. 평균을 기준으로 연금이 충분하다고 판단하면 낮은 구간에 남아 있는 사람을 놓친다. 반대로 가장 낮은 구간만 보고 전체 제도가 실패했다고 말하면 국민연금 성숙과 기초연금 확대가 만든 개선을 과소평가한다. 필요한 것은 평균과 분포를 함께 보는 일이다. 특히 여성, 비정규직, 자영업자, 장기 경력단절자, 농어촌 고령층은 같은 연금제도 안에서도 낮은 수령액 구간에 남을 가능성이 크다. 노후소득 정책은 이 집단을 특정하지 않으면 평균의 개선 뒤에 숨어 있는 취약성을 줄이기 어렵다.
...
결국 연금 분포는 청장년기 노동시장 이력의 누적표다. 안정적으로 오래 일한 사람, 직역연금이나 퇴직연금을 가진 사람, 배우자와 자산이 있는 사람은 노년기에 더 두꺼운 안전망을 갖는다. 반대로 낮은 임금, 경력단절, 돌봄 책임, 비공식 노동을 경험한 사람은 연금을 받더라도 낮은 구간에 머물 가능성이 크다. 고령화 정책이 연금제도 안에서만 끝날 수 없는 이유가 여기에 있다.
