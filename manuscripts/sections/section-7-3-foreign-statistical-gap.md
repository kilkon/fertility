...
이 책에서 사용한 국가데이터처 인구총조사 외국인 자료 `DT_1JA1503`은 “성 및 현재 국적별 외국인 - 시도” 표다. KOSIS 인구로 보는 대한민국의 관련통계표 설명도 이 지표를 시도 단위 표로 연결한다. 그래서 세 통계를 같은 방식으로 직접 비교할 수 있는 지역 단위는 시도이고, 시군구별 차이 분석은 행정안전부 외국인주민과 법무부 등록외국인을 중심으로 수행했다.
