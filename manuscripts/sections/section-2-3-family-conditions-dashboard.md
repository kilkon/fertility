...
그렇다면 청년의 소득은 적어도 좋아졌는가. 가계금융복지조사의 가구주 연령계층별 자료를 보면 29세 이하와 30대 가구주의 처분가능소득은 2017년 이후 명목 기준으로 분명히 증가했다. 29세 이하 가구주는 2017년 약 2,830만원에서 2025년 약 3,840만원으로, 30대 가구주는 약 4,530만원에서 약 5,980만원으로 늘었다. 이 숫자만 보면 청년 세대의 경제 조건이 나빠졌다고만 말하기 어렵다. 그러나 결혼과 출산의 판단은 소득의 절대액만으로 이루어지지 않는다. 같은 기간 주거비, 전세보증금, 부채 상환 부담, 고용 안정성, 앞으로의 소득 경로에 대한 기대가 함께 움직인다.

{{chart:young_income_trend_by_age}}

그래서 소득 증가는 두 가지 얼굴을 가진다. 한쪽 얼굴은 분명한 개선이다. 20대 후반과 30대가 이전보다 더 많은 소득을 얻고 있다는 사실은 결혼과 출산을 이야기할 때 놓쳐서는 안 된다. 그러나 다른 얼굴은 더 무겁다. 청년이 결혼을 결심하려면 “올해 얼마를 버는가”보다 “앞으로 10년 동안 버티고 계획할 수 있는가”가 더 중요하다. 집을 마련하거나 이사를 하고, 임신·출산기를 지나고, 아이가 어린이집과 초등학교에 들어갈 때까지의 생활비를 생각하면 명목소득의 상승은 곧바로 생활 안정감으로 번역되지 않는다. 저출산 정책이 현금지원만으로 충분하지 않은 이유도 여기에 있다.
...
그 범위 안에서 보면 수도권이 전국보다 일관되게 낮다고 말하기는 어렵다. 2025년 기준 삶에 만족한다고 응답한 비율은 전국 45.3%, 수도권 45.6%로 거의 비슷하고, 서울은 44.2%로 수도권 평균보다 낮지만 경기와 인천은 그보다 높다. 수도권의 청년이 더 힘들다는 주장은 주거비, 통근시간, 경쟁 압력, 일자리 불안 같은 구체적 경로를 통해 검증되어야 한다. 삶의 만족도 총점 하나로 “수도권 청년이 더 불행하다”고 결론 내리기는 어렵다. 오히려 정책적으로 중요한 질문은 수도권 청년이 더 낮은 만족도를 보이느냐가 아니라, 높은 기회와 높은 비용이 같은 공간에 결합될 때 결혼과 출산의 장기 계산이 어떻게 바뀌는가이다.
...
이 절은 저출산고령사회위원회의 「2024년 결혼·출산·양육 인식조사」와 「저출생 추세 반전을 위한 대책」, KIHASA의 「2024년도 가족과 출산 조사」와 저출산 정책 평가 연구, OECD의 일·가정 양립 연구, McDonald의 젠더 형평성 이론, KOSIS 가계금융복지조사와 한국행정연구원 사회통합실태조사, 국가데이터처 수도권 광역지표를 함께 참고해 작성했다.
