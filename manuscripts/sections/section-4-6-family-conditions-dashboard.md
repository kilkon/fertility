...
여기서는 의도적으로 결과 지표를 제외하고 조건 지표만 남겼다. 조혼인율과 조출생률은 정책이 겨냥하는 결과에 가깝기 때문에, 이 절에서는 결혼과 출산 이전의 생활조건이 실제로 좋아졌는지를 보는 데 집중한다. 육아휴직 수급자는 늘고, 야간연장 어린이집 비중도 높아졌다. 정책 장부 위에서는 일하는 부모의 시간 문제를 다루려는 장치가 확대된 셈이다. 그러나 40세 미만 가구주의 주택보유율은 개선되었다고 보기 어렵고, 청년 취업자 지수 역시 가족 형성의 자신감을 회복시킬 만큼 강하게 좋아졌다고 말하기 어렵다. 즉 일부 제도는 늘었지만, 결혼과 출산을 결정하는 바탕 조건은 같은 속도로 좋아지지 않았다.

이 대시보드는 정책효과를 직접 추정한 것이 아니라 조건의 방향을 점검하는 장치다. 육아휴직 수급자가 늘었다고 해서 모든 부모가 휴직을 쓸 수 있다는 뜻은 아니고, 야간연장 어린이집 비중이 높아졌다고 해서 모든 생활권에서 밤 시간 돌봄이 충분하다는 뜻도 아니다. 반대로 주택보유율이 낮다고 해서 모든 청년이 결혼을 포기한다는 뜻도 아니다. 중요한 것은 조건들이 서로 다른 방향으로 움직일 때 출산정책의 병목이 어디에 남는지 찾는 일이다. 제도가 늘어도 주거와 고용의 불확실성이 남으면 생활조건의 체감 개선은 제한적일 수 있다.
...
수도권의 20대와 30대가 다른 지역보다 더 낮은 삶의 만족도를 보이는지도 조심스럽게 보아야 한다. 공개된 KOSIS 사회통합실태조사 표는 연령별 삶의 만족도와 동·읍면부 분류를 제공하지만, “연령×수도권” 교차표를 바로 제공하지 않는다. 국가데이터처의 수도권 광역지표는 사회조사 마이크로데이터를 재산출해 수도권·서울·인천·경기의 삶의 만족도 비율을 제공하지만, 이 역시 전체 연령 기준이다. 따라서 아래 자료는 수도권 청년만을 직접 비교한 결과가 아니라, 수도권 전체의 주관적 삶의 질 배경을 살피는 보조 자료로 읽어야 한다.
...
따라서 질문은 수도권 청년이 더 낮은 만족도를 보이느냐에 그치지 않는다. 높은 기회와 높은 비용이 같은 공간에 결합될 때 결혼과 출산의 장기 계산은 어떻게 바뀌는가. 수도권 청년에게 필요한 주거·교통·돌봄 인프라는 무엇인가. 그리고 지역으로 이동하고 싶은 청년에게 실제로 열린 경로가 있는가. 수도권 청년 정책과 균형발전 정책은 서로 적이 아니다. 수도권에 사는 청년의 삶의 질을 높이는 일과, 지역에서 살 수 있는 선택지를 넓히는 일은 함께 설계되어야 한다.
...
특히 사각지대의 크기는 평균 지표보다 늦게 보인다. 대기업 정규직 노동자의 육아휴직 경험이 개선되어도 중소기업·비정규직·자영업자의 위험이 남아 있으면 제도는 계층적으로 작동한다. 국공립 또는 연장보육 시설이 늘어도 실제 출퇴근 동선과 맞지 않으면 부모는 사적 돌봄을 다시 찾아야 한다. 저출산 정책의 질은 “정책이 있는가”가 아니라 “가장 불안정한 생애조건에 있는 사람이 그 정책을 사용할 수 있는가”에서 갈린다.
...
이렇게 보면 4.6절의 그림은 단순하지만, 그 단순함이 오히려 중요한 출발점이 된다. 정책 이용 지표는 개선되는데 혼인과 출생, 주거 안정, 청년 고용의 지표가 같은 속도로 개선되지 않는다면, 정책은 생활조건의 일부만 건드리고 있을 가능성이 크다. 한국의 저출산 정책은 더 많은 사업을 만드는 방향이 아니라, 결혼과 육아의 질을 실제로 높이는 방향으로 평가틀을 바꾸어야 한다.
