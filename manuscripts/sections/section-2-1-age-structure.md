...
1980년, 1990년, 2020년, 2025년을 나란히 놓으면 변화는 더 분명해진다. 전후 베이비붐 세대는 시간이 흐르며 피라미드의 중심부에서 고령층으로 이동하고, 1997년 외환위기 이후의 고용 불안, 혼인 지연, 주거비 상승은 이후 출생 코호트가 얇아지는 과정과 겹쳐 나타난다. 물론 피라미드 하나가 특정 사건의 인과효과를 증명해 주지는 않는다. 다만 어느 세대가 어떤 사회경제적 조건 속에서 태어났고, 그 세대가 시간이 지나 어느 제도에 압력을 주는지를 읽게 해준다. 이 절의 목적은 인구피라미드의 모양을 묘사하는 데 그치지 않고, 세대의 두께와 빈틈을 역사적 시간 속에서 해석하는 데 있다.
...
이 점이 중요한 이유는 인구정책이 항상 늦게 반응하기 쉽기 때문이다. 2025년의 초등학생 규모는 2010년대 후반의 출생아 수가 이미 결정한 결과이고, 2040년대 노동시장에 들어올 청년 규모는 지금의 영유아 세대가 결정한다. 피라미드는 예측 모형은 아니지만, 어떤 정책이 이미 늦었고 어떤 정책은 아직 준비할 시간이 있는지를 알려주는 일정표에 가깝다. 학교와 군, 대학, 노동시장, 연금과 장기요양은 서로 다른 속도로 같은 코호트를 맞이한다.
