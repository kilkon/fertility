...
다만 비중이 높다는 사실은 두 가지 방식으로 읽어야 한다. 한편으로는 국제결혼이 그 지역의 가족 형성에서 실제로 중요한 통로가 되었다는 뜻이다. 다른 한편으로는 전체 혼인 건수가 매우 적기 때문에 국제결혼 몇 건만으로도 비중이 크게 뛸 수 있다는 뜻이기도 하다. 따라서 지도는 “국제결혼이 많은 지역”과 “전체 혼인이 작아 비중이 크게 보이는 지역”을 함께 보여준다. 정책 해석에서는 비중과 절대 건수를 같이 보아야 한다.
...
이 점에서 외국인 정책은 노동시장 정책과 가족정책 사이에 놓여 있다. 외국인이 산업단지와 농어촌에서 일하지만 가족동반, 주거, 의료, 자녀교육의 경로가 불안정하다면 지역은 노동력은 얻어도 주민은 얻지 못한다. 반대로 정착 경로가 열려 있고 지역사회가 언어·교육·돌봄 지원을 갖추면 외국인은 단기 인력이 아니라 지역의 다음 세대를 함께 구성하는 사람이 된다. 저출산 시대의 이민정책은 “몇 명을 데려올 것인가”보다 “어떤 권리와 생활조건 안에서 함께 살 것인가”를 물어야 한다.
...
::: pause 자료 출처와 해석상 주의
시군구 국제결혼 지도는 KOSIS [DT_1B83A24 시도/시군구별 외국인과의 혼인](https://kosis.kr/statHtml/statHtml.do?orgId=101&tblId=DT_1B83A24)을 사용했다. “한국인 남편+외국인 아내”와 “한국인 아내+외국인 남편”을 합산하고, 전체혼인건수는 남편 주소 기준 전체혼인과 아내 주소 기준 전체혼인의 평균을 사용했다. KOSIS 지역 코드와 지도 경계 코드가 일부 군 지역에서 다르게 제공되는 경우에는 같은 시도 안의 동일 지역명·영문명을 대조해 2018년 시군구 지도 경계 코드로 연결했다. 원자료는 시 단위인데 지도는 행정구 단위로 나뉘어 있거나, 반대로 원자료는 구 단위인데 지도는 시 단위로 묶여 있는 경우에는 경계 수준에 맞춰 같은 값을 하위 경계에 표시하거나 구 단위 값을 합산했다. 군위군의 대구 편입, 인천 미추홀구 명칭 변경처럼 2018년 지도 경계와 2024년 통계 명칭이 달라진 지역은 현재 통계값을 해당 경계에 연결했다. 따라서 이 지도는 공식 고시된 단일 “국제결혼율”이라기보다, 시군구별 가족 형성 구조를 비교하기 위한 재구성 지표다. 전체혼인 20건 미만 지역은 작은 분모 때문에 비중이 과도하게 튀는 것을 막기 위해 제외했다.
