...
특히 주거지원은 정책의 시점이 중요하다. 이미 아이를 낳은 가구에 주택 배정상의 우대를 주는 정책은 출산 이후의 안정에는 도움이 되지만, 출산 이전의 결정 자체를 바꾸는 효과는 제한적일 수 있다. 반대로 결혼 전후에 안정적 거주 전망을 제공하는 정책은 가족 형성의 문턱을 낮출 가능성이 있다. 같은 주택정책이라도 “보상”으로 작동하는지 “예측 가능한 미래”로 작동하는지에 따라 저출산 정책으로서의 의미가 달라진다.
...
따라서 주거지원의 핵심은 “집값을 대신 내주는 것”이 아니다. 결혼과 출산을 앞둔 사람이 앞으로 몇 년 동안 어디서 살 수 있는지, 아이가 태어난 뒤 집이 너무 좁아지지 않는지, 직장과 어린이집 사이의 이동시간이 감당 가능한지, 대출 상환이 둘째 출산의 위험으로 계산되지 않는지를 줄여 주는 일이다. 주거정책이 저출산 정책이 되려면 주택 공급, 금융, 교통, 돌봄, 학교 배치가 한 생활권 안에서 함께 설계되어야 한다.
