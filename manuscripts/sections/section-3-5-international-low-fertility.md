...
국제 비교의 목적은 한국이 몇 등인지를 확인하는 데 있지 않다. 같은 합계출산율 1.3명이라도 어떤 사회에서는 법률혼 안의 출산이 대부분이고, 어떤 사회에서는 동거와 비혼 부모의 출산이 큰 비중을 차지한다. 어떤 사회에서는 이민자 가족이 출생아 수를 보완하고, 어떤 사회에서는 국적·혼인·가족 규범이 출산의 통로를 좁힌다. 따라서 국제 비교는 출산율의 높낮이보다 “어떤 제도와 가족형태가 출산을 가능하게 하거나 막는가”를 묻는 작업이어야 한다.
...
{{chart:china_population_marriage_fertility}}
