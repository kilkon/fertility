...
또 하나 조심할 점은 고령층 증가를 곧바로 “부담 증가”로만 읽지 않는 것이다. 65세 이상 인구에는 여전히 일하는 사람, 가족과 지역을 돌보는 사람, 소비와 자원봉사로 지역경제를 지탱하는 사람이 포함된다. 문제는 나이가 아니라 건강상태, 소득, 이동권, 주거 안전, 돌봄 필요도가 어떻게 분포하느냐이다. 같은 고령층 증가라도 건강수명이 길고 지역사회 활동 기반이 있는 곳과, 독거·빈곤·교통 취약이 겹친 곳의 정책 수요는 다르다. 고령화 지도는 노인을 부담으로 낙인찍기 위한 그림이 아니라, 장수사회에 맞춰 생활권을 다시 설계해야 할 위치를 찾기 위한 도구다.
