...
여기에 한 가지 기준을 더 붙여야 한다. 정책이 없었더라도 출산율이 비슷하게 움직였을 가능성, 곧 반사실적을 생각해야 한다. 특정 국가에서 현금지원이 확대된 뒤 출산율이 올랐다고 해서 그 상승이 모두 현금지원의 효과라고 말할 수는 없다. 혼인 이연의 회복, 경기 변동, 이민, 세대 규모, 코로나19 이후의 지연 출산이 함께 작동할 수 있다. 국제 비교는 강력한 힌트를 주지만, 그것만으로 인과효과를 확정하지는 못한다. 따라서 이 절의 비교는 “어느 나라를 따라 할 것인가”가 아니라 “어떤 정책 조합이 어떤 조건에서 제한적으로 작동했는가”를 읽기 위한 것이다.
...
이 비교가 정책적으로 중요한 이유는 성공의 기준을 낮추자는 데 있지 않다. 오히려 기준을 더 정확히 세우자는 뜻이다. 한국이 싱가포르의 공공주택, 헝가리의 세제·대출 유인, 일본의 아동정책 통합을 각각 부분적으로 도입하더라도, 한국의 장시간 노동, 수도권 주거비, 사교육 경쟁, 낮은 비혼 출산 수용성, 성별 돌봄 격차가 그대로라면 결과는 제한적일 수밖에 없다. 국제 사례는 제도 목록이 아니라 제도가 작동하는 사회적 토양까지 함께 읽을 때 비로소 비교가 된다.
