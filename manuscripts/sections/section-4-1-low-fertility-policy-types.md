...
이 구분은 단순한 분류 작업이 아니다. 같은 “저출산 예산”이라도 출산 직후의 현금흐름을 보전하는 정책과 청년의 혼인 가능성을 앞당기는 정책, 둘째 출산의 시간 부담을 낮추는 정책, 지역 정주를 돕는 정책은 서로 다른 시점과 대상에게 작동한다. 따라서 어떤 정책이 효과가 없었다고 말하려면 먼저 그 정책이 겨냥한 경로가 무엇이었는지 확인해야 한다. 출산장려금에 돌봄 접근성의 책임을 물을 수 없고, 어린이집 확충에 청년 주거비 문제의 책임을 모두 물을 수도 없다. 정책을 한 묶음으로 부르면 예산은 커 보이지만, 실패의 원인은 오히려 흐려진다.
...
{{chart:low_fertility_budget_trend}}
...
{{chart:low_fertility_major_budget_2026}}
...
부처 간 분절은 특히 생애단계가 넘어갈 때 드러난다. 임신·출산기 지원은 보건의료 체계 안에 있고, 영유아 돌봄은 보육 체계 안에 있으며, 초등 이후 돌봄은 교육과 지자체 사업으로 흩어진다. 청년 주거지원은 국토교통부와 지자체의 영역이고, 육아휴직은 고용보험과 기업의 조직문화에 걸려 있다. 부모의 생활시간표에서는 이 모든 것이 하나의 연속된 경로지만, 행정에서는 서로 다른 사업명과 신청 창구로 분리된다. 거버넌스의 핵심은 새 조직을 하나 더 만드는 것이 아니라, 부모와 청년이 경험하는 경로를 기준으로 정책을 묶어내는 데 있다.
...
::: pause 출처와 읽는 기준
이 절의 정책 분류는 저출산고령사회위원회와 관계부처가 제시한 최근 저출생 대책의 큰 틀, 보건복지부의 출산·보육·아동 지원, 고용노동부의 모성보호·육아지원 제도, 국토교통부의 신혼·출산가구 주거지원 정책을 책의 분석 목적에 맞게 재분류한 것이다. 예산 규모는 2025년 시행계획 기준 확정액과 2026년 예산안 기준 주요사업 규모를 구분했다. 2026년 저출산·고령사회 시행계획 기준의 전체 저출생 대응 예산은 아직 같은 기준으로 최종 확정 공표되지 않았으므로, 추후 시행계획이 나오면 다시 갱신해야 한다.

참고 자료: [저출산고령사회위원회](https://www.betterfuture.go.kr), [2025년 저출산·고령사회 시행계획 확정 보도자료](https://www.betterfuture.go.kr/front/notificationSpace/pressReleaseDetail.do?articleId=496&listLen=10&pageIndex=1&position=M), [2026년 아동수당 확대 정책브리핑](https://www.korea.kr/news/policyNewsView.do?newsId=148963373&pWise=main&pWiseMain=K5), [보건복지부](https://www.mohw.go.kr), [고용노동부](https://www.moel.go.kr), [국토교통부](https://www.molit.go.kr), 국회예산정책처 2026년도 예산안 총괄 분석 IV.
:::
