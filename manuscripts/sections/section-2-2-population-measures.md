...
이 기준은 행정서비스를 운영하는 데 매우 유용하다. 주민등록인구는 국가가 국민을 행정적으로 확인하고 지방자치단체가 서비스를 배분할 때 사용하는 “국민의 인구”에 가깝다. 지방자치단체가 주민센터, 선거, 주민등록, 행정구역, 각종 민원과 복지 전달체계를 설계할 때는 주민등록 자료가 가장 빠르고 세밀하다. 매월 갱신되고 시군구·읍면동 단위까지 내려갈 수 있기 때문에 지역 변화를 민감하게 포착한다.
...
이 기준의 장점은 “국내에 실제로 살고 있는 사람”에 더 가까운 그림을 제공한다는 점이다. 인구총조사는 국적보다 거주 사실을 더 중시하는 “거주의 인구”에 가깝다. 외국인 장기체류자가 포함되기 때문에 한국 사회의 노동시장, 주거, 교육, 의료, 지역 인구구조를 해석할 때 주민등록인구보다 넓은 현실을 보여준다. 2024년 인구주택총조사에서 총인구는 약 5,180만 6천 명이었고, 그중 내국인은 약 4,976만 3천 명, 외국인은 약 204만 3천 명이었다. 내국인은 줄었지만 외국인이 늘면서 총인구 감소가 일부 상쇄된 것이다.
...
## 국가데이터처 추계인구: 미래를 읽기 위한 인구

국가데이터처 장래인구추계는 단순한 집계가 아니라 인구학적 회계다. 기준 인구를 놓고 출생, 사망, 국제이동을 더하고 빼면서 앞으로의 인구 규모와 연령구조를 전망한다. 그래서 추계인구는 현재의 인구명부라기보다 “미래를 읽기 위한 인구”다. “지금 주민등록표에 몇 명이 올라와 있는가”보다 “현재의 출산·사망·이동 흐름이 지속되거나 달라지면 인구구조가 어떻게 변하는가”를 묻는 데 적합하다.
...
정책 현장에서 자주 생기는 오류는 이 차이를 “어느 숫자가 맞는가”의 싸움으로 바꾸는 것이다. 그러나 세 통계는 서로 틀린 답이 아니라 서로 다른 질문에 대한 답이다. 지방세, 선거인명부, 주민센터 서비스처럼 법적 등록 상태가 중요한 사안에는 주민등록인구가 맞다. 실제 거주자 규모, 외국인 포함 생활수요, 가구구조를 보려면 인구총조사가 더 적절하다. 국민연금, 건강보험, 학교 수요, 장래 부양비처럼 앞으로의 흐름을 보려면 추계인구가 필요하다. 서로 다른 통계를 평균내어 하나의 “진짜 인구”를 만들려고 하면 오히려 정책 질문이 흐려진다.
