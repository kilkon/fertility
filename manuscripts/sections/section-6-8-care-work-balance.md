...
여기에는 고용보험 중심 제도의 한계도 겹친다. 출산전후휴가급여와 육아휴직급여는 제도적으로 중요한 안전망이지만, 안정적인 임금노동 관계 밖에 있는 자영업자, 플랫폼 노동자, 프리랜서, 영세사업장 노동자에게는 접근성이 낮을 수 있다. 저출산 정책이 “제도를 만든다”에서 멈추면 실제 사용 가능성의 격차를 놓친다. 부모가 제도를 쓸 수 있는 노동자와 쓸 수 없는 노동자로 나뉘는 순간, 일가정양립은 보편적 권리가 아니라 고용지위에 따른 특권처럼 작동할 위험이 있다.
