...
교육재정도 자동으로 가벼워지는 것은 아니다. 학생 수가 줄어도 학교 건물, 통학, 급식, 교원 배치, 특수교육, 방과후 돌봄처럼 고정비 성격의 지출은 쉽게 줄지 않는다. 농어촌에서는 학생 수 감소가 학급당 학생 수 개선이 아니라 학교 통폐합과 통학거리 증가로 나타날 수 있고, 대도시에서는 학생 수가 줄어도 상위권 입시 경쟁이 계속 특정 지역과 학교에 집중될 수 있다. 인구감소는 교육비를 줄이는 자동 장치가 아니라 교육 인프라를 어떻게 재배치할 것인지 묻는 압력이다.
...
따라서 학생 수 감소를 기회로 만들려면 두 가지를 동시에 해야 한다. 하나는 남는 자원을 아이 한 명 한 명에게 더 깊게 쓰는 것이다. 기초학력, 심리상담, 진로탐색, 방과후 돌봄, 특수교육처럼 사교육이 대신해 온 기능을 공교육 안에서 회복해야 한다. 다른 하나는 지역 교육망의 붕괴를 막는 것이다. 학교가 사라지는 지역에서는 교육 부담이 줄어드는 것이 아니라, 아이를 키우기 어려운 지역이라는 신호가 더 강해질 수 있다.
