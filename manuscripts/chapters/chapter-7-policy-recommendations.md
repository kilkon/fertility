...
이 책의 결론은 조용하지만 분명하다. 한국의 인구문제는 출산율만의 문제가 아니며, 노동력만의 문제도 아니다. 그것은 미래에 대한 신뢰의 문제다. 정책이 그 신뢰를 회복할 수 있다면 출산율이라는 숫자는 언젠가 뒤따라 움직일 수 있다. 설령 숫자가 기대만큼 빨리 움직이지 않더라도, 그런 사회는 지금보다 더 살 만한 사회일 것이다. 저출산·고령화 정책이 끝내 지향해야 할 곳도 바로 그 지점이다.
