한국의 저출산·고령화 정책은 오랫동안 하나의 급한 질문에 붙잡혀 있었다. 어떻게 하면 출산율을 올릴 수 있는가. 이 질문은 이해할 만하다. 합계출산율 0명대라는 숫자는 사회를 불안하게 만들고, 고령화율과 노년부양비의 상승은 재정과 노동시장에 실제 압력을 만든다. 그러나 이 책의 분석이 보여준 것은 더 근본적인 사실이다. 저출산은 출산의 문제가 아니라 삶의 구조가 미래를 감당하기 어렵게 된 결과다.

따라서 마지막 장의 질문은 조금 달라야 한다. 국가는 몇 명을 더 낳게 할 것인가가 아니라, 청년이 어떤 사회라면 미래를 계획할 수 있는가를 물어야 한다. 고령화 정책도 단순히 부족한 노동력을 메우는 문제가 아니라, 더 오래 사는 시민이 어떤 삶의 질과 존엄을 유지할 수 있는가를 물어야 한다. 저출산·고령화 정책의 중심은 인구 숫자가 아니라 삶의 가능성이다.

이 장의 제언은 네 축으로 정리할 수 있다. 청년에게는 완전히 예측 가능한 미래를 약속하기보다 회복력과 재도전 가능성을 보장해야 한다. 가족정책은 출산 여부와 무관하게 삶이 존중되는 사회를 지향해야 한다. 돌봄정책은 어린이집 중심 공급을 넘어 지역사회 공동 돌봄망으로 확장되어야 한다. 고령화 정책은 더 오래 일하게 하는 정책이 아니라 일할 권리와 멈출 권리의 균형을 다루어야 한다. 여기에 하나를 더 보태야 한다. 저출산은 제도와 비용의 문제인 동시에 문화적 현상이다. 결혼과 출산, 성별 관계, 한국사회에 대한 신뢰를 둘러싼 문화적 환경을 함께 보지 않으면 정책은 삶의 깊은 층위에 닿기 어렵다.
...
청년에게 필요한 정책은 단기 이벤트가 아니라 예측 가능한 경로다. 첫 직장을 얻고, 소득을 쌓고, 집을 구하고, 결혼 여부와 상관없이 독립된 삶을 꾸릴 수 있으며, 아이를 낳는다면 돌봄과 노동을 병행할 수 있다는 믿음이 있어야 한다. 미래가 불확실하면 사람은 큰 결정을 미룬다. 결혼도, 출산도, 지역 정착도 마찬가지다.
...
정책 언어도 바뀌어야 한다. “저출산 위기 극복”이라는 표현은 국가의 불안을 앞세운다. 청년에게 필요한 언어는 “당신의 삶이 실패하지 않도록 사회가 함께 부담하겠다”는 약속에 가깝다. 정책이 사람을 설득하려면 공포가 아니라 신뢰를 주어야 한다.
...
그러나 아이를 낳는 사람은 통계표 속의 출산율을 보고 결정을 내리지 않는다. 그는 자신이 살 집을 구할 수 있는지, 일자리를 잃지 않을지, 아이를 맡길 곳이 있는지, 교육비를 감당할 수 있는지, 배우자와 돌봄을 나눌 수 있는지, 아플 때 쉴 수 있는지, 노부모 돌봄까지 동시에 떠안게 되지는 않을지 생각한다. 출산 결정은 한 해의 사건이 아니라 장기 생활계획이다.
...
## 주거와 교육은 출산 이전의 장기 위험이다

주거정책은 저출산 정책의 주변부가 아니다. 한국에서 가족 형성은 함께 살 공간을 확보하는 문제와 깊게 연결된다. 특히 수도권에서는 일자리와 교육, 문화 자원이 집중된 공간이 동시에 가장 비싼 공간이 된다. 청년은 기회를 찾아 수도권으로 들어오지만, 가족을 만들 시점에는 주거비 때문에 밀려난다. 이 시간차가 혼인과 출산을 늦춘다.

다만 주거지원만으로 출산율을 끌어올릴 수 있다는 생각도 조심해야 한다. 집은 필요조건이지만 충분조건은 아니다. 집을 구해도 출퇴근 시간이 길고, 어린이집이 멀고, 노동시간이 길고, 교육비 부담이 크면 출산 결정은 여전히 어렵다. 주거정책은 돌봄, 교통, 일자리, 학교와 함께 생활권 단위로 설계되어야 한다.

교육은 출산 이후의 비용처럼 보이지만 실제로는 출산 이전의 예상 비용이다. 부모는 아이가 태어난 뒤의 분유값만 계산하지 않는다. 어린이집, 학원, 입시, 대학, 취업까지 이어지는 길을 상상한다. 사교육비가 높다는 사실보다 더 중요한 것은 그 경쟁을 부모가 사적으로 감당해야 한다고 느끼는 구조다.

따라서 교육정책은 저출산 정책의 핵심이다. 공교육의 신뢰가 낮고, 대학과 일자리의 보상이 좁은 문으로 연결되어 있으며, 부모가 아이의 미래를 전적으로 책임져야 한다고 느끼면 출산은 장기 채무처럼 인식된다. 교육경쟁을 완화하지 않는 저출산 정책은 아이를 낳으라는 말과 아이에게 더 많이 투자하라는 압박을 동시에 보내는 모순에 빠진다.

## 지역정책은 출생이 아니라 정주를 보아야 한다

지역 출산정책의 평가는 출생아 수에서 멈추면 안 된다. 이 책에서 본 것처럼 출생연도 0세 인구가 네 살까지 지역에 얼마나 남는지를 보면, 출산과 정주는 다른 문제라는 사실이 드러난다. 출산장려금은 출생 순간의 문턱을 낮출 수 있지만, 가족이 지역에 남는 힘은 일자리, 주거, 어린이집, 병원, 학교, 교통, 공동체가 함께 만든다.

지역정책은 모든 지자체가 같은 방식으로 인구를 늘리겠다는 경쟁에서 벗어나야 한다. 어떤 지역은 청년을 끌어들이는 일자리와 대학 기능이 중요하고, 어떤 지역은 고령층 생활권과 돌봄 접근성이 더 중요하다. 어떤 지역은 외국인과 다문화 가족의 정주를 중심에 놓아야 하고, 어떤 지역은 빈집과 생활서비스 축소를 관리해야 한다.

인구감소 지역의 목표도 “과거 인구 회복”만이 될 수 없다. 어떤 지역은 작아지더라도 인간다운 생활권을 유지하는 것이 더 현실적이고 중요한 목표일 수 있다. 학교, 의료, 돌봄, 교통, 상권을 어떻게 압축하고 연결할 것인지, 주민이 적어져도 존엄한 생활을 어떻게 보장할 것인지가 지역정책의 핵심 질문이 되어야 한다.

그러므로 지역 저출산 정책은 출산장려금 중심에서 정주권 중심으로 바뀌어야 한다. 아이가 태어난 뒤 부모가 계속 살 수 있는 지역, 외국인이 일하다 떠나는 곳이 아니라 가족과 함께 머물 수 있는 지역, 고령층이 병원과 돌봄에서 고립되지 않는 지역을 만드는 것이 더 중요한 성과 지표다.
...
## 문화: 갈등을 증폭하는 사회에서 가족은 미래가 되기 어렵다

저출산은 제도의 실패만으로 설명되지 않는다. 문화도 중요하다. 결혼과 출산은 미래를 함께 상상하는 행위인데, 사회 전체가 미래를 부정적으로만 말하고, 남성과 여성이 서로를 잠재적 위험으로 인식하며, 한국 사회에서 살아갈 이유보다 떠나야 할 이유만을 더 크게 말한다면 가족 형성의 의지는 약해질 수밖에 없다. 출산율은 가계소득과 주거비의 함수이기도 하지만, 동시에 사회가 서로를 얼마나 신뢰할 수 있는지의 함수이기도 하다.

특히 2010년대 중반 이후 한국 사회에서는 온라인 공간과 정치·언론 담론을 통해 남녀 갈등을 증폭시키는 언어가 빠르게 확산되었다. 물론 남녀 갈등이 저출산의 단일 원인이라고 말할 수는 없다. 그 배경에는 노동시장 격차, 돌봄 부담의 불평등, 군복무와 취업 경쟁, 주거비, 교육비, 세대 간 자원 배분 문제가 복합적으로 놓여 있다. 그러나 갈등을 설명하는 데서 그치지 않고 갈등 자체를 정체성 정치와 혐오의 언어로 키우는 행태는 결혼과 가족 형성에 필요한 상호 신뢰를 약화시켰다.

한국 사회에 대한 부정적 측면만을 강조하는 담론도 마찬가지다. 사회비판은 필요하다. 불평등, 성차별, 과로, 입시경쟁, 주거 불안, 지역 격차를 외면해서는 안 된다. 그러나 비판이 언제나 “이 사회에서는 미래가 없다”는 결론으로만 귀결되면 청년은 자신의 생애를 길게 계획하기 어렵다. 결혼과 출산은 현재의 만족만으로 이루어지지 않는다. 이 사회에서 아이가 자라도 괜찮을 것이라는 최소한의 신뢰가 필요하다.

따라서 문화정책은 홍보 캠페인으로 축소되어서는 안 된다. 필요한 것은 출산을 미화하는 선전이 아니라, 서로 다른 성별과 세대가 함께 살아갈 수 있다는 공적 언어를 회복하는 일이다. 남녀를 경쟁하는 피해자 집단으로만 묶지 않고, 돌봄과 노동과 생애 위험을 함께 나누는 동료 시민으로 말해야 한다. 한국 사회의 문제를 냉정하게 비판하되, 동시에 고칠 수 있다는 가능성을 말해야 한다. 저출산 정책이 삶의 조건을 바꾸는 정책이라면, 그 삶을 해석하는 문화의 언어도 정책의 일부다.
...
동시에 데이터는 겸손해야 한다. 출산과 돌봄, 노후의 삶은 숫자만으로 설명되지 않는다. 그러나 숫자 없이 정책을 말하면 책임이 흐려진다. 필요한 것은 사람의 삶을 존중하는 해석과, 그 해석을 검산할 수 있는 자료가 함께 가는 방식이다.

## 마지막 제언: 희망을 정책의 목표로 삼아야 한다
...
청년에게 필요한 희망은 막연한 낙관이 아니다. 안정된 일자리, 감당 가능한 주거, 신뢰할 수 있는 돌봄, 과도하지 않은 교육경쟁, 불이익 없는 육아휴직, 지역에서 살아갈 수 있는 생활권처럼 구체적인 제도에서 생겨나는 희망이다. 희망은 감정이지만, 그 감정은 제도 위에서 자란다.
...
이 책의 결론은 조용하지만 분명하다. 한국의 인구문제는 출산율만의 문제가 아니며, 노동력만의 문제도 아니다. 그것은 미래에 대한 신뢰의 문제다. 정책이 그 신뢰를 회복할 수 있다면 출산율이라는 숫자는 언젠가 뒤따라 움직일 수 있다. 설령 숫자가 기대만큼 빨리 움직이지 않더라도, 그런 사회는 지금보다 더 살 만한 사회일 것이다. 그리고 저출산·고령화 정책이 끝내 지향해야 할 곳은 바로 그 지점이다.
