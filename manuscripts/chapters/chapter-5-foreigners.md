...
- [7.1. 외국인은 누구인가](../sections/section-5-1-who-are-foreigners.html)

- [7.2. 외국인은 빠르게 증가하고 있는가](../sections/section-5-2-foreign-population-growth.html)

- [7.3. 외국인 통계는 왜 서로 다르게 보이는가](../sections/section-5-3-foreign-statistical-gap.html)
...
둘째, 외국인은 빠르게 증가하고 있지만 그 증가의 의미는 통계마다 다르다. 법무부 등록외국인은 코로나19 이후 다시 늘어났고, 체류외국인은 단기·장기 체류를 함께 포착한다. 행정안전부 외국인주민은 귀화자와 자녀까지 포함하기 때문에 지역사회가 실제로 감당해야 할 교육, 복지, 언어, 통합 수요에 더 가깝다.
...
다음 장에서는 다시 고령사회로 이동한다. 외국인 유입이 일부 노동력 공백을 완화할 수 있더라도, 한국 사회가 이미 마주한 고령화의 노동·의료·연금·재정 압력은 별도로 다루어야 한다. 결국 인구정책의 마지막 질문은 누가 들어오는가와 함께, 오래 사는 사회에서 누가 일하고 누가 돌보고 누가 비용을 나누는가이다.
