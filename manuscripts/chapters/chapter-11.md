...
> 청년에게 필요한 것은 확실한 미래가 아니라, 실패해도 다시 설 수 있는 사회다.
...
이 장은 저출산·고령화 정책을 다섯 축으로 압축했다. 청년에게는 모든 불확실성을 없애겠다는 약속보다 실패해도 다시 시작할 수 있는 회복력과 재도전 가능성이 필요하다. 가족정책은 출산한 사람만 보상하는 방식이 아니라, 출산 여부와 무관하게 삶이 존중되는 사회를 지향해야 한다.

돌봄정책은 어린이집 공급만으로 완성되지 않는다. 부모가 실제 생활권에서 필요한 시간에 믿고 맡길 수 있어야 하고, 학교·보건소·도서관·주민센터·기업·지역 공동체가 함께 돌봄망을 만들어야 한다. 고령화 정책은 더 오래 일하게 하는 정책이 아니라, 일할 권리와 멈출 권리가 함께 보장되는 사회를 만드는 일이다.

지역정책은 출생아 수 경쟁에서 벗어나 정주와 생활을 함께 보아야 한다. 주민등록인구가 줄어도 생활인구가 큰 지역이 있고, 주민등록인구가 남아 있어도 의료·돌봄·교통·상권이 다른 생활권에 의존하는 지역이 있다. 지역 인구정책의 성과는 주소를 붙잡는 데서 끝나지 않고, 사람들이 실제로 일하고 돌보고 배우고 치료받는 생활이 가능한가로 평가되어야 한다.

기존 통념과 가장 크게 다른 점은 출산율을 정책의 직접 목표처럼 다루지 않는다는 데 있다. 출산율은 중요하지만, 그것은 삶의 조건이 누적된 뒤 나타나는 결과다. 정책이 해야 할 일은 숫자를 명령하는 것이 아니라, 결혼과 출산을 포기하게 만드는 위험을 줄이고, 아이를 낳지 않는 삶도 동등하게 존중하며, 오래 사는 삶이 존엄을 잃지 않도록 제도를 다시 짜는 것이다.

따라서 마지막 제언은 공포가 아니라 선택의 언어로 남아야 한다. 대한민국은 사라지지 않는다. 다만 과거의 인구구조 위에서 작동하던 대한민국은 이미 사라지고 있다. 이제 필요한 것은 사라짐을 두려워하는 정치가 아니라, 달라진 사회를 감당할 제도를 만드는 정치다.

정책이 조심해야 할 점은 이 다섯 축을 다시 부처별 사업 목록으로 흩뜨리는 일이다. 청년, 가족, 돌봄, 고령화, 지역은 서로 다른 정책 대상이지만 실제 삶에서는 동시에 겹친다. 하나의 축만 보강하고 나머지 축이 무너지면 출산율도, 삶의 질도, 장수사회의 지속가능성도 충분히 달라지지 않는다.

이 책이 닫힌 뒤 남는 질문은 하나다. 한국은 사라짐의 공포를 반복하는 사회가 될 것인가, 아니면 달라진 인구구조에 맞춰 삶의 조건을 다시 설계하는 사회가 될 것인가. 마지막 제언은 그 질문에 대한 이 책의 답이다.
